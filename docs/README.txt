==============================================================================
CrysPy: Crystallographic Computations in Python::
*A Python Toolbox for EBSD Data Analysis*
==============================================================================

CrysPy is a Python toolbox for Crystallographic Computations. It intends to provide a set of
open source tools for visualization, analysis, and postprocessing of EBSD data.
