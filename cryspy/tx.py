...
def odf2fc(quaternions, weights, kernel_legendre_coefficients):
    ...
    prgpath = rh.fullfile([h.prgpth, prgname + h.ext])
    ...
    listfilepath = rh.fullfile([h.tmpdir, name + '.txt'])
